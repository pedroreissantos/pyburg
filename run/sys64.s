...
_sys6:	movq	%r9, 48(%rsp)
_sys5:	movq	%r8, 40(%rsp)
_sys4:	movq	%rcx, 32(%rsp)
_sys3:	movq	%rdx, 24(%rsp)
_sys2:	movq	%rsi, 16(%rsp)
_sys1:	movq	%rdi, 8(%rsp)
_sys0:
sys5:
sys4:
sys3:
